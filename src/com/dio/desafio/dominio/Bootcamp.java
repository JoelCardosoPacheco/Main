...
public class Bootcamp {
    ...
    public int hashCode() {
        ...
        result = prime * result + ((devsIsncritos == null) ? 0 : devsIsncritos.hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (dataFinal == null) {
            ...
            return false;
        if (devsIsncritos == null) {
            if (other.devsIsncritos != null)
                return false;
        } else if (!devsIsncritos.equals(other.devsIsncritos))
            return false;
        if (conteudos == null) {
